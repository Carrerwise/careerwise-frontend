...
interface UpdateCareerFormProps {
    setUpdateCareer: React.Dispatch<React.SetStateAction<number>>;
    careerId: number;
}

const UpdateCareerForm: React.FC<UpdateCareerFormProps> = ({setUpdateCareer, careerId}) => {
  ...
  useEffect(() => {
    ...
    const response = axios.get(`https://careerwise-api.crossnox.dev/careers/${careerId}`)
    .then(response => {
  ...
  const handleSubmit = async (event: React.FormEvent) => {
    ...
    try {
        ...
        const response = await axios.put<Career>(
            `https://careerwise-api.crossnox.dev/admins/${userEmail}/careers/${careerId}`,
            careerData
        );
